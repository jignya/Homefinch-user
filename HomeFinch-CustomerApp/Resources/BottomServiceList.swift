...
open class BottomServiceView: UIView {
    ...
    // MARK: - Constants
    private let kDefaultButtonHeight: CGFloat = 45
    private let kDefaultButtonSpacerHeight: CGFloat = 1
    private let kCornerRadius: CGFloat = 22.5
    ...
    @objc public init(
        ...
        super.init(frame: CGRect(x: 0, y: size.height - 130 , width: size.width, height: 80))
...
//        }
    ...
    private func createContainerView() -> UIView {
        ...
        self.frame = CGRect(x: 0, y: screenSize.height - 130 - bottomPadding, width: screenSize.width, height: 80)
...
//        self.layer.shadowPath = shadowPath.cgPath
        ...
        self.dropShadow(color: UIColor(red: 0, green: 0, blue: 0, alpha: 0.07), offSet: CGSize(width: 0.0, height: -3.0))
...
//        container.addSubview(lineView)
    ...
    private func addButtonsToView(container: UIView) {
        let buttonWidth = container.bounds.size.width / 2 - 65
        ...
        self.doneButton.titleLabel?.font = UIFont.roboto(size: 14, weight: .Bold)
        ...
        let imageview = UIImageView(frame: CGRect(x: self.doneButton.frame.origin.x + buttonWidth - 20, y: self.doneButton.frame.origin.y + 17.5, width: 10, height: 10))
