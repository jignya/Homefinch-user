...
class EmployeeData : NSObject, NSCoding{
    ...
    var dob : String!
    var email : String!
    var employeeServiceUnitSkill : EmployeeServiceUnitSkill!
    var employeeSkill : [EmployeeSkill]!
    var employeeSlotGroup : [EmployeeSlotGroup]!
    ...
    init(fromJson json: JSON!){
        ...
        let employeeServiceUnitSkillJson = json["employee_service_unit_skill"]
        if !employeeServiceUnitSkillJson.isEmpty{
            employeeServiceUnitSkill = EmployeeServiceUnitSkill(fromJson: employeeServiceUnitSkillJson)
        }
        ...
        employeeSlotGroup = [EmployeeSlotGroup]()
        let employeeSlotGroupArray = json["employee_slot_group"].arrayValue
        for employeeSlotGroupJson in employeeSlotGroupArray{
            let value = EmployeeSlotGroup(fromJson: employeeSlotGroupJson)
            employeeSlotGroup.append(value)
        }
        ...
        sauSapId = json["sau_sap_id"].stringValue
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if employeeServiceUnitSkill != nil{
            dictionary["employee_service_unit_skill"] = employeeServiceUnitSkill.toDictionary()
        }
        ...
        if employeeSlotGroup != nil{
            var dictionaryElements = [[String:Any]]()
            for employeeSlotGroupElement in employeeSlotGroup {
                dictionaryElements.append(employeeSlotGroupElement.toDictionary())
            }
            dictionary["employee_slot_group"] = dictionaryElements
        }
        if firstName != nil{
        ...
        if sauSapId != nil{
            dictionary["sau_sap_id"] = sauSapId
        }
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
         ...
         employeeServiceUnitSkill = aDecoder.decodeObject(forKey: "employee_service_unit_skill") as? EmployeeServiceUnitSkill
         employeeSkill = aDecoder.decodeObject(forKey: "employee_skill") as? [EmployeeSkill]
         employeeSlotGroup = aDecoder.decodeObject(forKey: "employee_slot_group") as? [EmployeeSlotGroup]
         ...
         sauSapId = aDecoder.decodeObject(forKey: "sau_sap_id") as? String
    ...
    */
    func encode(with aCoder: NSCoder)
    {
        ...
        if employeeServiceUnitSkill != nil{
            aCoder.encode(employeeServiceUnitSkill, forKey: "employee_service_unit_skill")
        }
        if employeeSkill != nil{
            aCoder.encode(employeeSkill, forKey: "employee_skill")
        }
        if employeeSlotGroup != nil{
            aCoder.encode(employeeSlotGroup, forKey: "employee_slot_group")
        }
        if firstName != nil{
        ...
        if sauSapId != nil{
            aCoder.encode(sauSapId, forKey: "sau_sap_id")
        }
        if serviceStartDate != nil{
