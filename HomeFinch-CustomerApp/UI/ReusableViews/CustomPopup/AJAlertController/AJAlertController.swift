...
//            conViewCenter.constant =  Height - ViewHeight
        ...
        btnCancel.roundCorners(corners: [.topLeft, .bottomLeft], radius: 25)
        btnOther.roundCorners(corners: [.topRight, .bottomRight], radius: 25)
    }
    ...
    private func show()
    {
        DispatchQueue.main.async {
            ...
            if let appDelegate = UIApplication.shared.delegate, let window = appDelegate.window, let rootViewController = window?.rootViewController {
                ...
                topViewController.present(self, animated: self.isBottom) {}
...
//        }
    ...
    public func showAlert(iscloseShow:Bool? = false,isBottomShow:Bool,aStrTitle:String, aStrMessage:String,
    ...
    public func showAlertWithOkButton(iscloseShow:Bool? = false,isBottomShow:Bool, aStrTitle:String,aStrMessage:String , aOKBtnTitle:String?,                                completion : alertCompletionBlock){
