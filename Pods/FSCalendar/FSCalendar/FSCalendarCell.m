...
//    _imageView.frame = CGRectMake(self.preferredImageOffset.x, self.preferredImageOffset.y, self.contentView.fs_width, self.contentView.fs_height);
    ...
    _imageView.frame = CGRectMake((self.contentView.fs_width - 11)/2, self.bounds.size.height - 15, 11, 11);

    _imageView.backgroundColor = [UIColor whiteColor];
    _imageView.layer.cornerRadius = _imageView.bounds.size.height/2;
...
//    CGFloat titleHeight = self.bounds.size.height*5.0/6.0;
    ...
    _shapeLayer.frame = CGRectMake((self.bounds.size.width-diameter - 5)/2 ,
                                   (self.bounds.size.height-diameter - 5)/2,
                                   diameter + 5,
                                   diameter + 5);
