...
- (void)layoutSubviews
{
    ...
    self.collectionView.frame = CGRectMake(0, self.fs_height*0.1, self.frame.size.width - 40, self.fs_height*0.9);
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self) {
        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 0, self.frame.size.width - 60, self.frame.size.height)];
